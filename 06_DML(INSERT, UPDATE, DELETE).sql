...
INSERT INTO EMPLOYEE2 VALUES(900, '장채현', '901123-2345678', 'jang_ch@kh.or.kr', '01012341234','D1', 'J7', 'S3', 
...
SELECT *
FROM DEPARTMENT2 d 
-- 테이블 컬럼 순서대로 작성하고 데이터 타입 맞출 것

ROLLBACK; --> INSERT했던 내용들 전부 제거
---------------------------------------
...
INSERT INTO DEPARTMENT2 d (DEPT_ID, LOCATION_ID)
VALUES ('D0', 'L1');
